...
[[nodiscard]] static inline std::string toString(ResponseCode val) {
  ...
  case ResponseCode::TOO_MANY_APP_KEYS:
    return "TOO_MANY_APP_KEYS";
  case ResponseCode::TOO_MANY_APP_KEYS_SDK37:
    return "TOO_MANY_APP_KEYS_SDK37";
  default:
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
template <>
constexpr inline std::array<aidl::android::system::keystore2::ResponseCode, 20> enum_values<aidl::android::system::keystore2::ResponseCode> = {
  ...
  aidl::android::system::keystore2::ResponseCode::TOO_MANY_APP_KEYS,
  aidl::android::system::keystore2::ResponseCode::TOO_MANY_APP_KEYS_SDK37,
};
#pragma clang diagnostic pop
}  // namespace internal
}  // namespace ndk
