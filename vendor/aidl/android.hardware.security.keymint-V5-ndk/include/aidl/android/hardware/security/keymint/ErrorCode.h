...
[[nodiscard]] static inline std::string toString(ErrorCode val) {
  ...
  case ErrorCode::UNSUPPORTED_ML_DSA_VARIANT:
    return "UNSUPPORTED_ML_DSA_VARIANT";
...
template <>
constexpr inline std::array<aidl::android::hardware::security::keymint::ErrorCode, 89> enum_values<aidl::android::hardware::security::keymint::ErrorCode> = {
  ...
  aidl::android::hardware::security::keymint::ErrorCode::UNSUPPORTED_ML_DSA_VARIANT,
