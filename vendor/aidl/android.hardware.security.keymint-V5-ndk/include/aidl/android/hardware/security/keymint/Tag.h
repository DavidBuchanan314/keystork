...
template <>
constexpr inline std::array<aidl::android::hardware::security::keymint::Tag, 68> enum_values<aidl::android::hardware::security::keymint::Tag> = {
  ...
  aidl::android::hardware::security::keymint::Tag::ML_DSA_VARIANT,
