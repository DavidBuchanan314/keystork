...
static AIBinder_Class* get_g_aidl_android_hardware_security_keymint_IKeyMintDevice_clazz() {
  static const char* get_g_aidl_android_hardware_security_keymint_IKeyMintDevice_clazz_names[] = {
    "getHardwareInfo",
    "addRngEntropy",
    "generateKey",
    "importKey",
  ...
  static AIBinder_Class* clazz = ::ndk::ICInterface::defineClass(IKeyMintDevice::descriptor, _aidl_android_hardware_security_keymint_IKeyMintDevice_onTransact, get_g_aidl_android_hardware_security_keymint_IKeyMintDevice_clazz_names, 18);
  return clazz;
}
...
::ndk::SpAIBinder BnKeyMintDevice::createBinder() {
  AIBinder* binder = AIBinder_new(get_g_aidl_android_hardware_security_keymint_IKeyMintDevice_clazz(), static_cast<void*>(this));
  #ifdef BINDER_STABILITY_SUPPORT
...
std::shared_ptr<IKeyMintDevice> IKeyMintDevice::fromBinder(const ::ndk::SpAIBinder& binder) {
  if (!AIBinder_associateClass(binder.get(), get_g_aidl_android_hardware_security_keymint_IKeyMintDevice_clazz())) {
